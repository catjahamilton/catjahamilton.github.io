$(document).ready(function() {
    ...
    var $container = $(".my-masonry-flex-container")
    $container.imagesLoaded().always(function(instance) {
        $container.masonry({
            itemSelector: ".my-flex-item",
            columnWidth: ".my-flex-item",
    ...
    var $infiniteContainer = $(".my-masonry-flex-container.infinite-scroll").infinitescroll({
        navSelector: "ul.pagination",
        nextSelector: "ul.pagination a:last",
        itemSelector: ".my-masonry-flex-container .my-flex-item",
